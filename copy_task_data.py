...
class CopyTaskDataset(Dataset):
    ...
    def __init__(self, src_file, tgt_file, src_pad_idx=None, tgt_pad_idx=None,
                 src_vocab=None, tgt_vocab=None, device='cuda'):
        # if pad_idx is None, automatically add it as an extra word in vocab
    ...
    def set_src_pad_idx(self):
        src_pad_idx = self.src_vocab.size()
        self.src_vocab.set_pad_id(src_pad_idx)
        return src_pad_idx

    def set_tgt_pad_idx(self):
        tgt_pad_idx = self.tgt_vocab.size()
        self.tgt_vocab.set_pad_id(tgt_pad_idx)
        return tgt_pad_idx
    ...
    def text_to_data(self, src_file, tgt_file, src_pad_idx, tgt_pad_idx,
        ...
        if src_pad_idx is None:
            src_pad_idx = self.set_src_pad_idx()

        if tgt_pad_idx is None:
            tgt_pad_idx = self.set_tgt_pad_idx()
