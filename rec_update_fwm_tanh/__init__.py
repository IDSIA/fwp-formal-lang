...
class RecurrentDelta(torch.autograd.Function):
    ...
    def forward(ctx, qx, kx, vx, bx, R_q, R_k, R_v, r_b, W, h0):
        ...
        RecurrentDelta.dot[device.type](
            qx.data,
            kx.data,
            vx.data,
            bx.data,
    ...
    def backward(ctx, grad_out):
        ...
        RecurrentDelta.dot_backward[out.device.type](
            Q.data,
            K.data,
            V.data,
            beta.data,
...
rec_delta_fn = RecurrentDelta.apply
